...
public class DefaultTrainingemptyService implements TrainingemptyService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultTrainingemptyService.class);
	...
	{
		return DefaultTrainingemptyService.class.getResourceAsStream("/trainingempty/sap-hybris-platform.png");
	}
